...
export function PortfolioNav() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 py-3 md:py-3 flex justify-between items-center gap-4">
          <Link
            href="/"
            className="text-xl md:text-2xl font-bold hover:opacity-70 transition-opacity flex-shrink-0"
          >
            {t("logo")}
          </Link>
